...
void APhoenixCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &APhoenixCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &APhoenixCharacter::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &APhoenixCharacter::OnResetVR);
}


void APhoenixCharacter::OnResetVR()
{
	// If Phoenix is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Phoenix.Build.cs is not automatically propagated
...
void APhoenixCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void APhoenixCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
